...
*/
var ConcreteCoding;
(function (ConcreteCoding) {
    var KnockoutToWinJS;
    (function (KnockoutToWinJS) {
        "use strict";
                        ...
                        for (var property in value) {
                            ...
                            if (value.hasOwnProperty(property) && (property.toString().substr(0, 2) != "on")) {
                                if (propertyProcessor && propertyProcessor[property] !== undefined) {
                                    options[property] = propertyProcessor[property](value[property], function () {
                                        return element;
                                    });
                                }
                                else {
                        ...
                        for (var property in value) {
                            if (value.hasOwnProperty(property) && (property.toString().substr(0, 2) === "on")) {
                                if (eventProcessor && eventProcessor[property] !== undefined) {
                                    control[property] = function (eventInfo) {
                            ...
                            if (value.hasOwnProperty(property)) {
                                if (property.toString().substr(0, 2) != "on") {
                                    ...
                                    if (control[property] !== unwrappedValue) {
                                        if (propertyProcessor && propertyProcessor[property] !== undefined) {
                                            var returnValue = propertyProcessor[property](value[property], function () {
                                                return element;
                                            }, control[property]);
                                            if (returnValue !== null) {
        ...
        KnockoutToWinJS.addBindings = addBindings;
        function handleChangeEvents(eventName, changedProperty, control, value, changeOverride) {
            ...
            if (eventName) {
                ...
                control[eventName] = function (eventInfo) {
        ...
        KnockoutToWinJS.handleChangeEvents = handleChangeEvents;
        ...
        KnockoutToWinJS.addRemoveClickHandlers = addRemoveClickHandlers;
        ...
        KnockoutToWinJS.bindingListWatch = bindingListWatch;
        ...
        KnockoutToWinJS.itemTemplateWatch = itemTemplateWatch;
        KnockoutToWinJS.controls = {
            "WinJS.UI.AppBar": {
            ...
            "WinJS.UI.DatePicker": {
                ...
                changeOverride: function (currentValue, newValue) {
                    var hours = 0;
                    var minutes = 0;
                    var seconds = 0;
                    var milliseconds = 0;
            ...
            "WinJS.UI.ListView": {
                ...
                eventProcessor: {
                    'oniteminvoked': function (handler, viewModel, eventInfo) {
    ...
    })(KnockoutToWinJS = ConcreteCoding.KnockoutToWinJS || (ConcreteCoding.KnockoutToWinJS = {}));
})(ConcreteCoding || (ConcreteCoding = {}));
(function () {
    WinJS.Application.addEventListener("ready", function (eventInfo) {
